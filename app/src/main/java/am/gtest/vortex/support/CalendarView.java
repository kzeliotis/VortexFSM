...
public class CalendarView extends LinearLayout {
    ...
    private void assignClickHandlers() {
        ...
        btnNext.setOnClickListener(v -> {
            ...
            updateCalendar(CALENDAR_EVENTS);
        });
...
//        header.setBackgroundColor(getResources().getColor(color));
    ...
    private class CalendarAdapter extends ArrayAdapter<Date> {
        ...
        private CalendarAdapter(Context context, ArrayList<Date> days, HashSet<Date> eventDays) {
                ...
                if (eventDays != null) {
                    for (Date eventDate : eventDays) {
                        if (eventDate.getDate() == day && eventDate.getMonth() == month && eventDate.getYear() == year) {
                            ...
                            view.setBackgroundResource(R.color.red_300);
                            break;
                        }
                    }
                }
...
//                ((TextView)view).setTextColor(getResources().getColor(R.color.today));
            ...
            view.setOnClickListener(v -> {
                if (clickEventHandler != null) {
                    clickEventHandler.onDayClicked( date );
                }
            });
