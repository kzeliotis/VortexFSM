...
import am.gtest.vortex.data.AssignmentTypesData;
import am.gtest.vortex.support.MyPrefs;

import static am.gtest.vortex.api.MyApi.API_GET_ASSIGNMENT_ACTIONS;
import static am.gtest.vortex.api.MyApi.API_GET_ASSIGNMENT_TYPES;
...
import static am.gtest.vortex.support.MyPrefs.PREF_DATA_ASSIGNMENT_TYPES;

public class GetAssignmentTypes  extends AsyncTask<String, Void, String > {
    ...
    protected String doInBackground(String... params) {
        ...
        apiUrl = baseHostUrl + API_GET_ASSIGNMENT_TYPES;
...
//        MyLogs.showFullLog("myLogs: " + this.getClass().getSimpleName(), apiUrl, MyGlobals.CONST_NO_BODY_FOR_GET_REQUEST, responseCode, responseMessage, responseBody);
        ...
        if (responseCode == 200 && responseBody != null && !responseBody.isEmpty()) {
            MyPrefs.setString(PREF_DATA_ASSIGNMENT_TYPES, responseBody);
            AssignmentTypesData.generate(responseBody);
        }
    }
