        ...
        public String toString() {
            String modelToString =
                    "{\n" +
                            ...
                            "  \"ProjectZoneDescription\": \"" + getZoneName() + "\",\n" +
                            "  \"zoneFullName\": \"" + getZoneFullName() + "\",\n" +
                            "  \"ProjectZoneNotes\": \"" + getZoneNotes() + "\",\n" +
                            "  \"ProjectInstallationId\": \"" + getProjectInstallationId() + "\",\n" +
                            "  \"ProjectZoneCode\": \"" + getZoneCode() + "\",\n" +
                            "  \"CustomFieldsString\": \"" + getCustomFieldsString() + "\",\n" +
                            "  \"CustomFields\": " + getZoneCustomFields() + "\n" +
                            "}";
