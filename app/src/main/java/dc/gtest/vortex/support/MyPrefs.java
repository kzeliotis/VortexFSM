...
public class MyPrefs {
    ...
    public static final String PREF_FILE_WAREHOUSE_PRODUCTS_FOR_SHOW = "pref_file_warehouse_products_for_show";
    ...
    public static final String PREF_NEW_ASSIGNMENT_FIELDS_OPTIONAL = "pref_new_assignment_fields_optional";
    public static final String PREF_ALLOW_ASSIGNMENT_WITHOUT_DATE = "pref_allow_assignment_without_date";
    public static final String PREF_DEFAULT_ASSIGNMENT_TYPE_ID = "pref_default_assignment_type_id";
    ...
    public static final String PREF_SHOW_PRODUCTS_TREE = "pref_show_products_tree";
    ...
    public static final String PREF_USER_GOOGLE_ID = "user_google_id";
